        ...
        <div className="flex flex-col gap-4 ">
            <div className="flex   gap-3 items-center">
                ...
                <div className="px-3 w-72 py-1.5 border border-white/10 bg-transparent rounded-lg text-sm flex items-center gap-3">
                    ...
                    <input onChange={onSearchInputChanged} className="bg-transparent flex-1 outline-none h-auto border-0 p-0 text-sm ring-0" placeholder="Buscar participantes" />
                </div>
            ...
            <Table>
                <thead>
                    <tr className="border-b border-white/10 ">
                        ...
                        <TableHeader>Data de Inscriçao</TableHeader>
